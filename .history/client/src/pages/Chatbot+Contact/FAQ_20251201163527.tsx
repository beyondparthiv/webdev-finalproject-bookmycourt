...
export const FAQ: React.FC = () => {
  ...
  const faqs: FAQItem[] = [
    ...
    {
      question: "How do you play pickleball?",
      answer: "Pickleball is played with a paddle and a plastic ball with holes. The game combines elements of tennis, badminton, and ping-pong. You can find detailed rules on our Rules page."
    }
  ];
